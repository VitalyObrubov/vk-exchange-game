...
def run_migrations_offline():
    ...
    print(f"_________ofline___________{url}")
    context.configure(
        url=url,
...
def run_migrations_online():
    ...
    """
    print("_________online___________")
    set_sqlalchemy_url(app_config['user'],app_config['password'],app_config['host'], app_config['database'])
    print(f"_________{config.config_ini_section}___________")
    print(f"_________{config.get_section(config.config_ini_section)}___________")
